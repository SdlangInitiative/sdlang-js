...
import { SdlTokenType } from "./lexer";
var ANONYMOUS_TAG_NAME = "content";
export function parseAndVisit(reader, visitor) {
    visitor.reset();
    var copy = null;
    var startOfLine = true;
    function valueAsSdlValue(reader) {
    ...
    while (reader.token.type !== SdlTokenType.EndOfFile) {
        switch (reader.token.type) {
            ...
            case SdlTokenType.TimeSpan:
                ...
                break;
            case SdlTokenType.BlockClose:
                visitor.visitCloseBlock();
                break;
            case SdlTokenType.BlockOpen:
                visitor.visitOpenBlock();
                break;
            case SdlTokenType.Comment:
                visitor.visitComment(reader.token.text);
                break;
